...
public class DemoDepthCrawler extends BreadthCrawler{
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        if(Integer.parseInt(page.meta("depth"))>1) {
            try {
                System.out.println(ContentExtractor.getNewsByHtml(page.html(), page.url()).getTitle());
            } catch (Exception e) {
            }
        }
    }
